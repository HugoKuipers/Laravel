...
@section("content")
  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2 comment-spacing">
  ...
  <div class="row">
    <div id="comment-form" class="col-md-8 col-md-offset-2 comment-spacing">
      {{ Form::open(['route'=>['comments.store', $post->id], 'method'=>'POST']) }}
        <div class='row'>
          ...
          <div class='col-md-12'>
            ...
            {{ Form::submit('Add Comment', ['class'=>'btn btn-success btn-block some-but-space']) }}
          </div>
        </div>
      {{ Form::close() }}
    </div>
